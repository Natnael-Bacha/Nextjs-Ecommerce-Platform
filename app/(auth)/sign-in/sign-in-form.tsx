      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-3 font-medium text-zinc-400">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-md border border-zinc-200 bg-white py-2.5 transition hover:bg-zinc-50 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-70"
        >
          <svg
